...
Public Class AddComponents
            ...
            Else
                ...
                For c = 0 To ListView2.Items.Count - 1
                    If Not (hecho.Contains(nombres(c))) Then
                        If gens(c) <> "" Then
                            top = top + vbCrLf + "component " + nombres(c) + vbCrLf + "generic(" + gens(c) + ");" + vbCrLf + "Port(" + entidad(c) + ");" + vbCrLf + "end component;"
                        Else
                ...
                For c = 0 To ListView2.Items.Count - 1
                    ...
                    'Se adquieren los Generics de cada componente
                    fileReader = My.Computer.FileSystem.ReadAllText(".\FILES\" + ListView2.Items(c).SubItems(4).Text)
                    fileReader = fileReader.ToUpper
                    b = Split(fileReader, "GENERIC(")
                    ...
                    If b.Length > 1 Then
                        ...
                        For Each gen In b
                            ...
                            bb = Split(bb(0), ":=")
                            ccc = Split(bb(0), ":")
                            bbb = bbb + ccc(0) + "=>" + InputBox("union_" + nombres(c) + "_" + CStr(c) + ":" + bb(0), "Se ha encontrado un generic", CStr(bb(1))) + vbCrLf + ","

                        Next

                        bbb = bbb.Substring(0, bbb.Length - 1)
                        MsgBox(bbb)
                        generics.Add(bbb, "union_" + nombres(c) + "_" + CStr(c))
                    ...
                    entidad(c) = Join(b, ",")
                    entidad(c) = entidad(c).Replace("??", ":=")
                    If generics.Contains("union_" + nombres(c) + "_" + CStr(c)) Then
                        top = top + vbCrLf + "union_" + nombres(c) + "_" + CStr(c) + ": " + nombres(c) + vbCrLf + "generic map(" + generics("union_" + nombres(c) + "_" + CStr(c)) + ")" + vbCrLf + "Port map(" + entidad(c) + ");" + vbCrLf
                    Else
    ...
    Private Sub AddComponents_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TabControl1.Height = Me.Size.Height - 80
        TabControl1.Width = Me.Size.Width - 39
        ListView1.Height = ((Me.Size.Height - 150) / 2) - 5
        ListView2.Height = ((Me.Size.Height - 150) / 2) - 10
        ListView2.Top = ((Me.Size.Height - 150) / 2) + 50
        ListView2.Width = Me.Size.Width - 80
        ListView1.Width = Me.Size.Width - 80
        carga()
    ...
    Private Sub SalirToolStripMenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SalirToolStripMenuItem2.Click
        End
    End Sub

    Private Sub NuevoProyectoToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NuevoProyectoToolStripMenuItem.Click
        If MsgBox("¿Esta seguro de descartar el proyecto actual y crear uno nuevo?", MsgBoxStyle.YesNo, "Advertencia") = vbYes Then
            ListBox1.Items.Clear()
            ListBox2.Items.Clear()
            ListView2.Items.Clear()
    ...
    Private Sub AddComponents_ResizeEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ResizeEnd
        TabControl1.Height = Me.Size.Height - 80
        TabControl1.Width = Me.Size.Width - 39
        ListView1.Height = ((Me.Size.Height - 150) / 2) - 5
        ListView2.Height = ((Me.Size.Height - 150) / 2) - 10
    ...
    Private Sub AddComponents_SizeChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.SizeChanged
        TabControl1.Height = Me.Size.Height - 80
        TabControl1.Width = Me.Size.Width - 39
        ListView1.Height = ((Me.Size.Height - 150) / 2) - 5
        ListView2.Height = ((Me.Size.Height - 150) / 2) - 10
